...
## 已完成验证
- 最终入口：`run_smoke.cmd --output reports/e3_routing_smoke/results/verified-cpu-v5-annotated-20260906`。
...
| --- | ---: | ---: | ---: |
| MoE | 92.834 | 93.849 | +1.09% |
| MoT | 106.955 | 108.202 | +1.17% |
| Latent | 99.654 | 98.111 | -1.55% |
...
## 证据位置
- [最终结果](results/verified-cpu-v5-annotated-20260906/summary.json)
- [带数值的总览图](results/verified-cpu-v5-annotated-20260906/routing_snapshot.png)
- [MoE 图](results/verified-cpu-v5-annotated-20260906/moe_expert_usage.png)
- [MoT 图](results/verified-cpu-v5-annotated-20260906/mot_expert_usage.png)
- [Latent 图](results/verified-cpu-v5-annotated-20260906/latent_expert_usage.png)
- [逐层记录](results/verified-cpu-v5-annotated-20260906/routing_snapshot.jsonl)
- [原始计时与一致性](results/verified-cpu-v5-annotated-20260906/routing_snapshot.json)
- [完整日志](results/verified-cpu-v5-annotated-20260906/full.log)
