...
## 已完成验证
- 最终入口：`run_smoke.cmd --output reports/e3_routing_smoke/results/verified-cpu-v2-20260905`。
...
| --- | ---: | ---: | ---: |
| MoE | 166.301 | 165.188 | -0.67% |
| MoT | 185.487 | 193.330 | +4.23% |
| Latent | 134.929 | 131.722 | -2.38% |
...
## 证据位置
- [最终结果](results/verified-cpu-v2-20260905/summary.json)
- [路由图](results/verified-cpu-v2-20260905/routing_snapshot.png)
- [逐层记录](results/verified-cpu-v2-20260905/routing_snapshot.jsonl)
- [原始计时与一致性](results/verified-cpu-v2-20260905/routing_snapshot.json)
- [完整日志](results/verified-cpu-v2-20260905/full.log)
